...
# TODO: fjern denne under det er Håkon sin
#text = ""
...
def freq_analysis(text, m):
    ...
    for i in range(m):
        ...
        for a in alphabet:
            ...
            text_frequencies[a] = c/len(text_shift)
...
def main():
    ...
    print("This is the codeword: ", codeword)

    result = decryption(text,codeword)
    print("This is the result of the decryption: ", result)
